...
export async function POST(req: Request) {
  try {
    ...
    const system = "You are an expert e-commerce translator/copywriter. Translate Arabic product descriptions into natural professional English without adding facts.";
    const user = `Translate the Arabic product description into professional English e-commerce copy.
Rules:
- Keep facts exactly as provided; do NOT add specs or claims.
...
`;
    ...
    const translated = await callPerplexity([
