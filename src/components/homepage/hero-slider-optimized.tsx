...
interface HeroSliderOptimizedProps {
  initialSlides: HeroSlide[]
}

export function HeroSliderOptimized({ initialSlides }: HeroSliderOptimizedProps) {
  ...
  if (slides.length === 0) {
    return (
      <div className="relative w-full h-[50vh] min-h-[400px] md:h-[70vh] md:min-h-[500px] bg-muted flex items-center justify-center">
        <p className="text-muted-foreground">لا توجد شرائح عرض</p>
      </div>
    )
  }
